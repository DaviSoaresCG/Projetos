...
def edita_atividade(id):
    ...
    #talvez de errado, se der, troque o 'atividade.cod_instrutor' por atividade.intrutor
    instrutor = conector_instrutor.get_one(atividade.cod_instrutor)
    plano = conector_plano.get_one(atividade.cod_tipo_plano.id_plano)
...
def mostra_detalhes(id):
    atividade = conector_atividade.get_one(id)
    tipo_plano = conector_plano.get_one(atividade.cod_tipo_plano.id_plano)
